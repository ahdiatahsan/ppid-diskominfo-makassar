                ...
                <div class="kt-portlet__body">
                    <div class="form-group">
                        ...
                        <input class="form-control @error('judul') is-invalid @enderror" type="text" name="judul"
                            id="judul" value="{{ $infografis->judul }}" required>
                    </div>

                    <div class="form-group form-group-last">
                        <label>File Infografis</label><span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="gambar_lama" id="gambar_lama"
                            value="{{ $infografis->gambar }}" readonly hidden>
