...
<form action="{{ route('berkala.update', $berkala->id) }}" method="POST" enctype="multipart/form-data"
    autocomplete="off">
    @csrf
    @method('PATCH')
                ...
                <div class="kt-portlet__body">
                    <div class="form-group">
                        ...
                        <input class="form-control @error('ringkasan') is-invalid @enderror" type="text"
                            name="ringkasan" id="ringkasan" value="{{ $berkala->ringkasan }}" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('unit') is-invalid @enderror" type="text" name="unit"
                            id="unit" value="{{ $berkala->unit }}" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('penanggungjawab') is-invalid @enderror" type="text"
                            name="penanggungjawab" id="penanggungjawab" value="{{ $berkala->penanggungjawab }}"
                            required>
                    </div>
